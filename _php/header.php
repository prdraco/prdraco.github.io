...
<div id="header" class="header-home ">
    <div class="container">
        ...
        <a href="<?=$websiteUrl?>/home" id="logo" title="Animes House">
        ...
        <div class="header-group">
            <div class="zoro-group">
                <div class="zrg-title"><span class="top">Join now</span><span class="bottom">Animes House Groups</span></div>
                <div class="zrg-list">
        ...
        <div class="header-setting">
            <div class="hs-toggles">
                <a href="<?=$websiteUrl?>/latest/dubbed" class="hst-item" data-toggle="tooltip" data-original-title="Select Anime List">
                    <div class="hst-icon"><i class="fas fa-star"></i></div>
                    <div class="name"><span>Dubbed</span></div>
                </a>
                <a href="<?=$websiteUrl?>/latest/subbed" class="hst-item" data-toggle="tooltip" data-original-title="Anime Movies">
                    <div class="hst-icon"><i class="fas fa-star"></i></div>
                    <div class="name"><span>Subbed</span></div>
                </a>
                 <a href="<?=$websiteUrl?>/latest/chinese" class="hst-item" data-toggle="tooltip" data-original-title="Anime Movies">
                    <div class="hst-icon"><i class="fas fa-star"></i></div>
                    <div class="name"><span>Chinese</span></div>
                </a>
