...
<head>
    <title><?=$name?> on Animes House</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="<?=$name?> on Animes House">
    ...
    <meta property="og:title" content="<?=$name?> on Animes House">
    <meta property="og:description" content="<?=$name?> on Animes House in HD with No Ads. Watch anime online">
                                    ...
                                    <div class="flw-item">
                                        ...
                                        <div class="tick ltr">
                                            ...
                                            <img class="film-poster-img lazyload"
                                                ...
                                                alt="stream <?=$subCat['animeTitle']?> free online Animes House watch">
