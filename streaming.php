...
$download = str_replace("Gogoanime", "Animes House", $getEpisode['ep_download']);
...
<head>
    <title>Watch <?=$getEpisode['animeNameWithEP']?>on Animes House</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$getEpisode['animeNameWithEP']?> on Animes House">
    <meta name="description" content="<?=substr($getAnime['synopsis'],0, 150)?> ... at <?=$websiteUrl?>">
    <meta name="keywords" content="Animes House, <?=$getEpisode['animeNameWithEP']?>,<?=$getAnime['name']?>, watch anime online, free anime, anime stream, anime hd, english sub">
    <meta name="charset" content="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1">
    <meta name="robots" content="index, follow">
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta http-equiv="Content-Language" content="en">
    <meta property="og:title" content="Watch <?=$getEpisode['animeNameWithEP']?>on Animes House">
    <meta property="og:description" content="<?=substr($getAnime['synopsis'],0, 150)?> ... at <?=$websiteUrl?>">
    <meta property="og:locale" content="en_US">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Animes House">
    ...
    <meta property="twitter:title" content="Watch <?=$getEpisode['animeNameWithEP']?>on Animes House">
                                ...
                                <div class="player-servers">
                                    <div id="servers-content">
                                        <div class="ps_-status">
                                            <div class="content">
                                                <div class="server-notice"><strong>Currently watching <b>Episode <?=$getEpisode['ep_num']?></b></strong> (If current server doesn't work please try other servers beside.)</div>
                                            </div>
                                        </div>
                                        <div class="ps_-block ps_-block-sub servers-mixed">
                                            ...
                                            <div class="ps__-list">
											<div class="item">
                                                    <a id="server1" href="https://the.animezia.com/player/v1.php?id=<?=$url?>&download=<?=$download?>" target="iframe-to-load" class="btn btn-server active">vidstream</a>
                                                </div>
                                                <div class="item">
                                                    <a id="server2" href="https://animezia.com/player/<?=$url?>" target="iframe-to-load" class="btn btn-server">StreamSB</a></a>
                                                </div>
												
												<div class="item">
                                                    <a id="server3" href="https://the.animezia.com/player/v2.php?id=<?=$url?>" target="iframe-to-load" class="btn btn-server">VidCloud</a>
                                                </div>
  ...
  if (event.key === "Enter") {
                                ...
                                <div class="anis-content">
                                    <div class="anisc-poster">
                                        <div class="film-poster">
                                            <img src="https://ik.imagekit.io/<?=$imgk?>/tr:w-200,f-webp/<?=$getAnime['imageUrl']?>"
                                                ...
                                                alt="Watch free online <?=$getAnime['name']?> on Animes House">
                                        </div>
                                    </div>
                                    <div class="anisc-detail">
                                        ...
                                        <div class="film-text m-hide mb-3">
                                            ...
                                            Animes House is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality
                                        </div>
    ...
    <div id="footer-about">
        <div class="container">
            <div class="footer-top">
                ...
                <div class="footer-joingroup">
                    <div class="zoro-group">
                        <div class="zrg-title"><span class="top">Join now</span><span class="bottom">Animes House
                                Groups</span></div>
                        <div class="zrg-list">
            ...
            <div class="about-text">Animes House does not store any files on our server, we only share link to the
                media which is hosted on 3rd party services.</div>
           <p class="copyright">Made with <i class="fas fa-heart"></i> For Anime Users!. Animes House</p>
        </div>
    </div>
</div>
