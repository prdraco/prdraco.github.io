...
<head>
    <title>Watch <?=$getAnime['name']?> - Animes House</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$getAnime['name']?> - Animes House" />
    <meta name="description" content="<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On Animes House" />
    <meta name="keywords" content="Animes House, watch anime online, free anime, anime stream, anime hd, english sub, kissanime, gogoanime, animeultima, 9anime, 123animes, Animes House, vidstreaming, gogo-stream, animekisa, zoro.to, gogoanime.run, animefrenzy, animekisa" />
    <meta name="charset" content="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1" />
    <meta name="robots" content="index, follow" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
    <meta http-equiv="Content-Language" content="en" />
    <meta property="og:title" content="Watch <?=$getAnime['name']?> - Animes House">
    <meta property="og:description" content="W<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On Animes House.">
    ...
    <meta property="twitter:title" content="Watch <?=$getAnime['name']?> - Animes House">
    <meta property="twitter:description" ontent="W<?=substr($getAnime['synopsis'],0, 90)?>.... Read More On Animes House.">
                    ...
                    <div class="container">
                        ...
                        <div class="anis-content">
                            ...
                            <div class="anisc-detail">
                                ...
                                <div class="film-text m-hide">Animes House is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality</div>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="film-text w-hide">Animes House is a site to watch online anime like <strong><?=$getAnime['name']?></strong> online, or you can even watch <strong><?=$getAnime['name']?></strong> in HD quality</div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
