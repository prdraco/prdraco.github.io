...
<head>
    <title>Animes House -Assistir Animes Online - Anime Online HD ! </title>
    <script src="https://ads.holid.io/auto/animeshouse.live/holid.js" defer="defer"></script>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    <meta name="robots" content="index,follow" />
    <meta http-equiv="content-language" content="en" />
     <meta name="title" content="Animes House -Assistir Animes Online - Anime Online HD ! " />
    <meta name="description" content="Animes House -Assista Animes Online HD, Melhores Animes em HD , Animes Downloads ,Tensei Shitara Slime Datta Ken,Dodoro online HD,Black Clover,tate no yuusha no nariagari " />
    <meta name="keywords" content="Tensei Shitara Slime Datta Ken,One piece ,Kakegurui XX, Domestic Girlfriend ,JoJo no Kimyou na Bouken Ougon no Kaze,FAIRY TAIL 2018, SWORD ART ONLINE ALICIZATION,Radiant , One Punch 2,One punch segunda temporada,download animes,Hinomaruzumou,Dodoro online HD,Black Clover,tate no yuusha no nariagari, Animes House, Animes House anime, download anime, otakuu, watch anime online, free anime, anime stream, anime hd, english sub, kissanime, gogoanime, animeultima, 9anime, 123animes, vidstreaming, gogo-stream, animekisa, zoro.to, gogoanime.run, animefrenzy, animekisa" />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="<?=$websiteUrl?>" />
    <meta property="og:title" content="Animes House -Assistir Animes Online - Anime Online HD ! " />
    <meta property="og:image" content="<?=$cdn?>/images/banner.webp" />
    <meta property="og:description "
        content="Animes House -Assista Animes Online HD, Melhores Animes em HD , Animes Downloads ,Tensei Shitara Slime Datta Ken,Dodoro online HD,Black Clover,tate no yuusha no nariagari " />
                    ...
                    <div class="mwt-content">
                        ...
                        <div class="mwh-logo">
                            <a href="<?=$websiteUrl?>/home" class="mwh-logo-div">
                                <img src="/Logo.png" alt="Animes House">
                            </a>
                            <div class="clearfix"></div>
                        </div>
            ...
            <div class="mw-body">
                <div class="container">
                    <div id="action-button">
                        <a href="/home" class="btn btn-lg btn-radius btn-primary">Watch Now <i
                    ...
                    <div class="mwb-2col">
                        <div class="mwb-left" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            <h1 itemprop="name" class="mw-heading">Animes House - The best site to watch anime online for Free</h1>
                            ...
                            <p>Just like free online movie streaming sites, anime watching sites are not created
                                equally,
                                some are better than the rest, so we've decided to build Animes House to be one of the best
                                free
                                anime streaming site for all anime fans on the world. Also, We are just indexing api results. Blame Consumet api</p>
                            <h2>1/ What is Animes House?</h2>
                            <p>Animes House is a free site to watch anime and you can even download subbed or dubbed anime in
                            ...
                            <h2>3/ So what make Animes House the best site to watch anime free online?</h2>
                            <p>Before building Animes House, we've checked many other free anime sites, and learnt from them.
                                We
                                only keep the good things and remove all the bad things from all the competitors, to put
                                it
                                in our Animes House website. Let's see how we're so confident about being the best site for
                                anime
                                streaming:</p>
                            <ul>
                                <li><strong>Safety:</strong> We try our best to not having harmful ads on Animes House.
                                </li>
                                ...
                                <li><strong>Quality/Resolution:</strong> All titles are in excellent resolution, the
                                    best
                                    quality possible. Animes House also has a quality setting function to make sure our users
                                    can
                                ...
                                <li><strong>Streaming experience:</strong> Compared to other anime streaming sites, the
                                    loading speed at Animes House is faster. Downloading is just as easy as streaming, you
                                    won't
                                ...
                                <li><strong>Updates:</strong> We updates new titles as well as fulfill the requests on a
                                    daily basis so be warned, you will never run out of what to watch on Animes House.
                                </li>
                                ...
                                <li><strong>Device compatibility:</strong> Animes House works alright on both your mobile and
                            ...
                            <p>So if you're looking for a trustworthy and safe site for your Anime streaming, let's give
                                Animes House a try. And if you like us, please help us to spread the words and do not forget
                                to
                                bookmark our site.</p>
                            <p>Thank you!</p>
                            <p>&nbsp;</p>
        ...
        <div id="xfooter-about">
            <div class="container">
                <p class="copyright">© 2023
                     <a href="<?=$websiteUrl?>">Animes House</a>.
                </p>
            </div>
        </div>
        <!--End: Footer-->
