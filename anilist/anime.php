...
<head>
    <title>Watch <?=$title['romaji']?> - Animes House</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta name="title" content="Watch <?=$title['romaji']?> - Animes House" />
    <meta name="description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On Animes House" />
    ...
    <meta property="og:title" content="Watch <?=$title['romaji']?> - Animes House">
    <meta property="og:description" content="<?=substr($getAnime['description'],0, 90)?>.... Read More On Animes House.">
    ...
    <meta property="twitter:title" content="Watch <?=$title['romaji']?> - Animes House">
    <meta property="twitter:description" ontent="<?=substr($getAnime['description'],0, 90)?>.... Read More On Animes House.">
