                    ...
                    <div class="container">
                        ...
                        <div class="anis-content">
                            ...
                            <div class="anisc-detail">
                                ...
                                <div class="film-text m-hide">Animes House is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                            ...
                            <div class="anisc-info-wrap">
                                <div class="anisc-info">
                                    ...
                                    <div class="film-text w-hide">Animes House is a site to watch online anime like <strong><?=$title['romaji']?></strong> online, or you can even watch <strong><?=$title['romaji']?></strong> in HD quality</div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="clearfix"></div>
